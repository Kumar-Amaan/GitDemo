...
//		For opening inspect using Keyboard-F12...
...
//		WebElement elementLocator = driver.findElement(By.xpath("//a[.='Start Testing']"));
//		actions.contextClick(elementLocator).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ARROW_DOWN)
//				.sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ARROW_DOWN).sendKeys(Keys.ARROW_DOWN).build().perform();
